export function HowTo(onPlay: () => void, onBack: () => void) {
  ...
  el.innerHTML = `
    ...
    <button id="home" class="ab-icon-btn fixed left-1/2 -translate-x-1/2 z-[40] pointer-events-auto" style="bottom: calc(env(safe-area-inset-bottom, 0px) + 20px)" aria-label="InÃ­cio">
