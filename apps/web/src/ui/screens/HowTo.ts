...
export function HowTo(onPlay: () => void, onBack: () => void) {
  ...
  el.innerHTML = `
    ...
    <div class="relative z-10 w-full max-w-[400px] mx-auto flex flex-col items-center howto-content howto-shell">
      ...
      <!-- TÃ­tulo -->
      <h1 class="howto-title w-10/12 max-w-[350px] mx-auto text-center text-white font-[800] uppercase tracking-[0.09em] leading-tight text-lg md:text-xl">COMO JOGAR</h1>
